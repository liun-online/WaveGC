...
from graphgps.layer.wave_san import WaveSAN
    ...
    def __init__(self, dim_in, dim_out):
        ...
        if cfg.WaveGC.weight_share:
            ...
            if cfg.WaveGC.trans_use:
                self.gen_wave = Wave_generatorV2(cfg.gt.layers-2, cfg.WaveGC.pre_s, cfg.gt.dim_hidden, cfg.WaveGC.nheads, cfg.WaveGC.num_n, cfg.WaveGC.num_J, cfg.WaveGC.trans_dropout)
            else:
                self.gen_wave = Wave_generatorV2(cfg.gt.layers, cfg.WaveGC.pre_s, cfg.gt.dim_hidden, cfg.WaveGC.nheads, cfg.WaveGC.num_n, cfg.WaveGC.num_J, cfg.WaveGC.trans_dropout)
        ...
        for i in range(cfg.gt.layers):
            layers.append(WaveLayer(
                ...
                adj_dropout=cfg.WaveGC.adj_dropout,
