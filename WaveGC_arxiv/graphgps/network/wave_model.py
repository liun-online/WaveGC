...
from graphgps.layer.wave_layer_large import WaveLayer_large
from graphgps.layer.wave_san import WaveSAN
from graphgps.layer.wave_san_large import WaveSAN_large
...
class WaveModel(torch.nn.Module):
    def __init__(self, dim_in, dim_out):
        ...
        if cfg.wandb.project == 'arxiv' or cfg.wandb.project == 'proteins':
            model = WaveLayer_large
        else:
            model = WaveLayer
        layers = []
